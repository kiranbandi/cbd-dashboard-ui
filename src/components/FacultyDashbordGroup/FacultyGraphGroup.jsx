        ...
        return (<div>
            {processedRecords.length > 0 && <div className='text-center'>
                ...
                <div className='faculty-graph-box m-b'>
                    <h3 style={{ color: printModeON ? 'black' : '' }} className="text-left m-b">EPA Expiry Rate <b className='title-append'>{!!currentFacultyData ? currentFacultyData.expired_epa_percentage : ''}</b></h3>
                    <FacultyGraph
                        printModeON={printModeON}
                        dateFilterActive={dateFilterActive}
                        startDate={startDate}
