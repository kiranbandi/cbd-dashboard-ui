    ...
    render() {
        return (
            <div className='m-a export-data-container'>
                ...
                <p className='text-warning info-text'> <span className="icon icon-info-with-circle"></span> Because of the secure nature of data involved and the fact that this is a bulk export please make sure that this file is stored and handled responsibly.</p>
